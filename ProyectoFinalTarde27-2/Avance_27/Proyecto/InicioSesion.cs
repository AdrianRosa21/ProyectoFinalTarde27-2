...
namespace Proyecto_FINAL
{
    ...
    public partial class InicioSesion : Form
    {
        ...
        public static class InfoSocios
        {
            ...
            public static string[,,] Socios = new string[3, 10000, 10]; // 3 categorias , 10000 regristos , 10 Datos 
            ...
            for (int plan = 0; plan < InfoSocios.Socios.GetLength(0); plan++) // Recorre las categorías (planes)
            {
                for (int i = 0; i < InfoSocios.contadorSocios; i++) // Recorre los registros
                {
                        ...
                        InfoSocios.Socios[plan, i, 4] == codigoAcceso) // Código de acceso
                    {
                        ...
                        //Calcular el imc y mandarlo al otro form.
                        double peso = double.Parse(InfoSocios.Socios[plan, i, 5]);
                        double altura = double.Parse(InfoSocios.Socios[plan, i,6]);
        ...
        private void CambiarPaginaUsuario()
        {
            try
            {
                Form3 form3 = new Form3(Admins.Admin, InfoSocios.Planes, InfoSocios.contadorSocios, InfoSocios.Socios, InfoSocios.ListaSocios, InfoSocios.generos, IMC);
                form3.Show();
